...
form.addEventListener("submit", (evento) => {
    ...
    localStorage.setItem("itens", JSON.stringify(itens)) //localStorage só entende string, então aqui transformei em string
...
function atuallizaElemento(item) {
